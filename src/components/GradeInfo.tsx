          ...
          <div className="flex flex-col gap-1.5 mb-3">
            {[
              ...
              <div key={grade} className="flex items-center gap-2">
                <span className={`${color} text-white font-display text-sm w-6 h-6 rounded flex items-center justify-center shrink-0`}>{grade}</span>
                <span className="font-mono text-xs text-zinc-500 dark:text-zinc-400">{pts}</span>
              </div>
            ))}
            <div className="flex items-center gap-2">
              <span className="bg-zinc-500 text-white font-display text-sm w-6 h-6 rounded flex items-center justify-center shrink-0">P</span>
              <span className="text-xs text-zinc-600 dark:text-zinc-300">Grade pending re-inspection</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="bg-zinc-400 text-white font-display text-sm w-6 h-6 rounded flex items-center justify-center shrink-0">N</span>
              <span className="text-xs text-zinc-600 dark:text-zinc-300">Not yet graded</span>
            </div>
          </div>
          <p className="text-[11px] text-zinc-400 dark:text-zinc-500 leading-relaxed">
            Restaurants scoring 14+ can request a re-inspection before a grade is posted.{' '}
            <a href="https://www.nyc.gov/site/doh/business/food-operators/letter-grading-for-restaurants.page"
